...
class CropWeatherCalendarPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> crops = [
      ...
      {'name': 'Jujube', 'image': 'assets/crops/jujube.png'},
      {'name': 'Jute', 'image': 'assets/crops/gram.png'},
      {'name': 'Lentil', 'image': 'assets/crops/lentil.png'},
      {'name': 'Mustard', 'image': 'assets/crops/gram.png'},
      {'name': 'Pointed Gourd', 'image': 'assets/crops/pointed-gourd.png'},
      {'name': 'Maize (Rabi)', 'image': 'assets/crops/maize.png'},
