...
import 'package:first_app/pages/smart_field.dart';
              ...
              : currentPageIndex == 1
                  ? Text('Our Services',
                      style: Theme.of(context)
                          ...
                          .copyWith(fontWeight: FontWeight.bold))
                  : currentPageIndex == 2
                      ? const Text('Smart Field Dashboard')
                      : currentPageIndex == 3
              ...
              child: IconButton.filledTonal(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          Notif(hardcodedNotifications: hardcodedNotifications),
                    ),
                  );
                },
                icon: badges.Badge(
